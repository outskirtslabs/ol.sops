...
image:https://img.shields.io/badge/doc-outskirtslabs-orange.svg[doc,link=http://docs.outskirtslabs.com/ol.sops/next/]
image:https://img.shields.io/badge/status-maturing-yellow.svg[status: maturing,link=http://docs.outskirtslabs.com/open-source-vital-signs#maturing]
